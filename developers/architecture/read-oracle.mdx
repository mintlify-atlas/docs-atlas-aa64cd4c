...
description: 'How to access and interpret market data using Mezo oracle infrastructure'
---
...
<ParamField path="Supported pair" type="string">
  BTC/USD only
</ParamField>

<ParamField path="Update frequency" type="string">
  Every block
</ParamField>

<ParamField path="Interface" type="string">
  [Chainlink Aggregator](https://github.com/smartcontractkit/libocr/blob/9e4afd8896f365b964bdf769ca28f373a3fb0300/contract/AccessControlledOffchainAggregator.sol)
</ParamField>
...
<ResponseField name="roundId" type="uint256">
  The round ID when the price was updated
</ResponseField>

<ResponseField name="answer" type="int256">
  The BTC/USD price (use `decimals()` to get the decimal precision)
</ResponseField>

<ResponseField name="startedAt" type="uint256">
