...
description: Overview of Mezo Earn, yield sources, and key concepts for earning with BTC and MEZO
---
...
<Note>
  [Download the Mezo Earn Whitepaper (PDF)](/Mezo_Earn_Whitepaper.pdf)
</Note>
...
<CardGroup cols={3}>
  ...
  <Card title="MUSD Lending Revenue" icon="dollar-sign">
  ...
  <Card title="Bridging & Transaction Fees" icon="link">
