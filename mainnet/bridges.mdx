...
The Mezo app includes a native bridge where you can deposit several assets to Mezo Mainnet. See the [Deposit Assets](/getting-started/deposit-assets) guide to learn how the process works, or go directly to [mezo.org/overview](https://mezo.org/overview), sign in, and click **Deposit Bitcoin** to get started.
...
Native BTC is bridged to tBTC before being bridged into the [Mezo App contract](/resources/contracts).
...
<Steps>
  <Step title="Click the 'Withdraw' button">
...
<Steps>
  ...
  <Step title="Choose BTC">
    Choose BTC as your asset.
  </Step>
  
  <Step title="Select Bitcoin network">
  ...
  <Step title="Paste your Bitcoin address">
...
<Steps>
  <Step title="Validation">
    The system verifies your request meets all requirements.
  </Step>
  
  <Step title="Token Burn">
    Your tokens on Mezo are burned (permanently removed from circulation).
  </Step>
  
  <Step title="Attestation">
    Mezo validators confirm your withdrawal request.
  </Step>
  
  <Step title="Delivery">
    Your assets are sent to your destination address.
  </Step>
</Steps>
...
A: See [Track Your Native Bitcoin Deposit](/mainnet/track-deposits) for a step-by-step guide on using tBTCScan to verify your deposit status.
...
<Steps>
  <Step title="Note your transaction details">
