...
<Steps>
  ...
  <Step title="Click Withdraw">
    Click "Withdraw" to bridge tokens from Mezo
  </Step>
  <Step title="Select MEZO token">
    Select MEZO token and enter the amount to withdraw
  </Step>
...
<Steps>
  ...
  <Step title="Click Deposit">
    Click "Deposit" to bridge tokens to Mezo
  </Step>
  <Step title="Select MEZO token">
    Select MEZO token and enter the amount to deposit
  </Step>
  <Step title="Confirm the transaction">
    Confirm the transaction in your wallet
  </Step>
...
<Steps>
  ...
  <Step title="Select chains">
    Select source and destination chains (Mezo ↔ Ethereum, Base, BSC, or Solana)
  </Step>
  <Step title="Choose MEZO">
    Choose MEZO as the token to bridge
  </Step>
...
<CardGroup cols={2}>
  <Card title="Wormhole NTT Documentation" icon="book" href="https://wormhole.com/docs/products/native-token-transfers/overview/">
    Learn more about Wormhole's Native Token Transfer protocol
  </Card>
  <Card title="Portal Bridge" icon="bridge" href="https://portalbridge.com/">
    Access the Portal Bridge interface
  </Card>
</CardGroup>
