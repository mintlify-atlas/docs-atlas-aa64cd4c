...
<Frame>
  <img src="/images/mezo-token/mezo-emissions.png" alt="Mezo Emissions Schedule" />
</Frame>

<Card title="Learn more about MEZO token Emissions" icon="arrow-right" href="/mezo/emissions">
  Explore the detailed MEZO emissions model and distribution flow
</Card>
