...
- [ActivePool](https://explorer.mezo.org/address/0x3012C2fE1240e3754E5C200A0946bb0E07474876) - Holds collateral for all active loans
- [DefaultPool](https://explorer.mezo.org/address/0xE4B5913C0c82dB2eFC553b95c0173efb90a07c8B) - Manages redistributed collateral from liquidations
- [CollSurplusPool](https://explorer.mezo.org/address/0xBF51807ACb3394B8550f0554FB9098856Ef5F491) - Holds surplus collateral after redemptions
- [GasPool](https://explorer.mezo.org/address/0x3EB418BdBE95b4b9cf465ecfBD8424685ACD1Bc1) - Manages gas deposits

### tBTC: The Backbone of MUSD Collateral

tBTC, which is built by the same team behind Mezo, [Thesis](https://thesis.co/?ref=blog.mezo.org), is powered by the [Threshold Network](https://threshold.network/?ref=blog.mezo.org). Threshold is a decentralized signer set that has operated the Threshold Bitcoin bridge since early 2020 and successfully bridged over 28k Bitcoin. 

<Note>
Proof of reserves for tBTC have been live for the entire life of the bridge and are viewable at [tbtcscan](https://tbtcscan.com/wallets?ref=blog.mezo.org).
</Note>
...
<Accordion title="Post-Debt Repayment">
...
<Accordion title="Critical Collateralization Ratio (CCR)">
...
<Accordion title="Collateral Surplus">
...
<Accordion title="Gas Compensation">
