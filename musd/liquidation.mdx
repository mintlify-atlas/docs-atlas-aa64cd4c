...
<Note>
Imagine your loan has 10,000 MUSD of debt. The value of your BTC collateral drops to $10,900. Your collateral ratio is now 109%, which is below the 110% minimum.
...
For a complete list of MUSD terms and definitions, see [Architecture & Terminology](/musd/architecture#definitions).
