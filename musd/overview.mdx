...
![MUSD Lets You Keep and Spend BTC](/images/musd/musd-keep-and-spend-btc.png)
...
![The Lifecycle of MUSD](/images/musd/musd-lifecycle.png)
...
![MUSD Redemption and Peg Process](/images/musd/musd-redemption-and-peg-process.png)

<Warning>
To ensure the peg holds during market volatility, all loan positions must maintain a collateral ratio above 110%. The system has built-in liquidation mechanisms and a stability pool to enforce this.
</Warning>

For details on how these safety mechanisms work, see [Liquidations & Redemptions](/musd/liquidation).
...
For Bitcoin holders, this is the most capital-efficient way to unlock liquidity without selling. That said, higher collateral ratios provide a bigger safety buffer — always consider the risk profile of your position.
...
![MUSD vs Traditional Finance](/images/musd/musd-vs-traditional.png)
...
<Accordion title="Fiat-Backed Stablecoins">
...
<Accordion title="Synthetic Stablecoins">
...
<Accordion title="CDP-Style Coins like USDS">
