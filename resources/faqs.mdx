...
<Accordion title="What can I do with Mezo?">
...
<Accordion title="Why should I use Mezo?">
...
<Accordion title="What are Mezo's flagship features?">
...
<Accordion title="How do I borrow against my Bitcoin?">
...
<Accordion title="How can I use Mezo for my dapp/project?">
...
<Accordion title="How do I invest in Mezo?">
  If you're interested in becoming an investor, please reach out to [IR@thesis.co](mailto:IR@thesis.co).
</Accordion>

<Accordion title="What wallets can I use with Mezo?">
...
<Accordion title="What token is used for transaction fees?">
...
<Accordion title="Why are some tokens that I own not shown in the Mezo Explorer?">
